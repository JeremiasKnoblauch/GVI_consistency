Check out the files 'BBGVI.py', 'Loss.py', 'Divergence.py' to get an idea about what object oriented programming looks like in practice once you have read up on it/done tutorials.
