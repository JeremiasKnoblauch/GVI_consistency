...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 13 19:06:51 2019

@author: jeremiasknoblauch

Description: BMM functions that generate data, perform inference & save results
"""
...
if TEST_BMM:
    ...
    #path to save stuff
    path_to_save = "/Users/jeremiasknoblauch/Documents/OxWaSP/GVI/JASA/code/experiments/BMM"
    file_name = "BMM_vanilla"
    file_id = "1"
    
    #Basic stuff
    d, num_clusters, n = 100, 2, 50
    ...
    #Problem set-up
    settings = {'test plot': True,
                'print outcomes': True,
                'outliers': True, 
                'outlier frequency': 0.05,
                'outlier size': 10.0, 
                'outlier variance': 3,
                'robust likelihood': True,
                'robust likelihood gamma': 1.001,
                'prior misspecification': False, 
